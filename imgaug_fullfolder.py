...
folder_name='/home/swec/imageaugmentation/imagefolder/'
...
for filename in os.listdir(directory):    
    if filename.endswith(".png"): 
        ...
        for i in range(n_augmentations):
            seq_det = img_aug_seq.seq.to_deterministic()
            ...
            #save the image
            skimage.io.imsave(folder_name+ name_img + '_' +str(i)+ '.png', image_aug)
            #save the image with bounding box
            if save_image_boundingbox:
                image_after = bbs_aug.draw_on_image(image_aug, thickness=2, color=[0, 0, 255])      
                skimage.io.imsave(folder_name+ name_img + '_' +str(i)+ 'bb.png', image_after)
            ...
            file_data = open(folder_name+ name_img + '_' +str(i)+ '.txt','w+')
